...
namespace RabbitMQ.Client.Impl
{
    ...
    public interface IFullModel : IModel
    {
        ...
        Task ConnectionTuneOk(ushort channelMax,
            uint frameMax,
            ushort heartbeat);
        ...
        Task _Private_BasicCancel(string consumerTag,
            bool nowait);
        ...
        Task _Private_BasicConsume(string queue,
            string consumerTag,
            bool noLocal,
        ...
        Task _Private_BasicGet(string queue,
            [AmqpFieldMapping(null, "noAck")] bool autoAck);
        ...
        Task _Private_BasicPublish(string exchange,
            string routingKey,
            bool mandatory,
            [AmqpContentHeaderMapping] IBasicProperties basicProperties,
            [AmqpContentBodyMapping] byte[] body);
        ...
        Task _Private_ChannelFlowOk(bool active);

        ///<summary>Used to send a Channel.Open. Called during session
        ///initialisation.</summary>
        [AmqpMethodMapping(null, "channel", "open")]
        Task _Private_ChannelOpen([AmqpFieldMapping("RabbitMQ.Client.Framing",
        ...
        Task _Private_ConnectionSecureOk(byte[] response);

        ///<summary>Used to send a Connection.StartOk. This is
        ///special, like Basic.Get.</summary>
        [AmqpForceOneWay]
        [AmqpMethodMapping(null, "connection", "start-ok")]
        Task _Private_ConnectionStartOk(IDictionary<string, object> clientProperties,
            string mechanism,
            byte[] response,
            string locale);
        ...
        Task _Private_ExchangeBind(string destination,
            string source,
            string routingKey,
        ...
        Task _Private_ExchangeDeclare(string exchange,
            string type,
            bool passive,
            bool durable,
            bool autoDelete,
        ...
        Task _Private_ExchangeDelete(string exchange,
            bool ifUnused,
            [AmqpNowaitArgument(null)] bool nowait);
        ...
        Task _Private_ExchangeUnbind(string destination,
            string source,
            string routingKey,
            [AmqpNowaitArgument(null)] bool nowait,
            IDictionary<string, object> arguments);
        ...
        Task _Private_QueueBind(string queue,
            string exchange,
            string routingKey,
            [AmqpNowaitArgument(null)] bool nowait,
            IDictionary<string, object> arguments);
        ...
        [AmqpForceOneWay]
        Task _Private_QueueDeclare(string queue,
            bool passive,
            bool durable,
            bool exclusive,
            bool autoDelete,
        ...
        Task<uint> _Private_QueueDelete(string queue,
            bool ifUnused,
            bool ifEmpty,
        ...
        Task<uint> _Private_QueuePurge(string queue,
            [AmqpNowaitArgument(null, "0xFFFFFFFF")] bool nowait);
    }
