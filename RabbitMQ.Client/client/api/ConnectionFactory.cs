...
namespace RabbitMQ.Client
{
    ...
    public class ConnectionFactory : ConnectionFactoryBase, IAsyncConnectionFactory
    {
        ...
        /// </exception>
        public virtual Task<IConnection> CreateConnection()
        {
        ...
        /// When the configured hostname was not reachable.
        /// </exception>
        public Task<IConnection> CreateConnection(String clientProvidedName)
        {
        ...
        /// </exception>
        public Task<IConnection> CreateConnection(IList<string> hostnames)
        {
        ...
        /// When no hostname was reachable.
        /// </exception>
        public Task<IConnection> CreateConnection(IList<string> hostnames, String clientProvidedName)
        {
        ...
        /// When no hostname was reachable.
        /// </exception>
        public Task<IConnection> CreateConnection(IList<AmqpTcpEndpoint> endpoints)
        {
        ...
        /// When no hostname was reachable.
        /// </exception>
        public async Task<IConnection> CreateConnection(IEndpointResolver endpointResolver, String clientProvidedName)
        {
            IConnection conn;
            try
            {
                if (AutomaticRecoveryEnabled)
                {
                    ...
                    await autorecoveringConnection.Init(endpointResolver);
                    conn = autorecoveringConnection;
                }
                else
                {
                    IProtocol protocol = Protocols.DefaultProtocol;
                    conn = protocol.CreateConnection(this, false, await endpointResolver.SelectOne(this.CreateFrameHandler), clientProvidedName);
                }
        ...
        public async Task<IFrameHandler> CreateFrameHandler(AmqpTcpEndpoint endpoint)
        {
