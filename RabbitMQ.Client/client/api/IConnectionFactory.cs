...
namespace RabbitMQ.Client
{
    public interface IConnectionFactory
    {
        ...
        /// </param>
        /// <returns></returns>
        Task<IConnection> CreateConnection(String clientProvidedName);
        ...
        /// <returns></returns>
        Task<IConnection> CreateConnection(IList<string> hostnames);
        ...
        /// </param>
        /// <returns></returns>
        Task<IConnection> CreateConnection(IList<string> hostnames, String clientProvidedName);
        ...
        /// </exception>
        Task<IConnection> CreateConnection(IList<AmqpTcpEndpoint> endpoints);
