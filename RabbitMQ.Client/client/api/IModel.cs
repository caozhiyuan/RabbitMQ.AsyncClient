...
namespace RabbitMQ.Client
{
    ...
    public interface IModel
    {
        ...
        /// </summary>
        [AmqpMethodDoNotImplement(null)]
        Task<BasicGetResult> BasicGet(string queue, bool autoAck);
        ...
        /// </remarks>
        [AmqpMethodDoNotImplement(null)]
        Task BasicPublish(string exchange, string routingKey, bool mandatory,
        ...
        /// Deprecated. Should not be used.
        /// </summary>
        Task BasicRecoverAsync(bool requeue);
        ...
        ///   </para>
        /// </remarks>        
        Task ExchangeBindNoWait(string destination, string source, string routingKey,
            IDictionary<string, object> arguments);
        ...
        /// </summary>
        Task ExchangeDeclareNoWait(string exchange, string type, bool durable, bool autoDelete,
            IDictionary<string, object> arguments);
        ...
        /// </summary>
        [AmqpMethodDoNotImplement(null)]
        Task ExchangeDelete(string exchange, bool ifUnused);

        /// <summary>
        /// Like ExchangeDelete but sets nowait to true.
        /// </summary>
        Task ExchangeDeleteNoWait(string exchange, bool ifUnused);
        ...
        /// </remarks>
        [AmqpMethodDoNotImplement(null)]
        Task ExchangeUnbind(string destination,
            string source,
            string routingKey,
            IDictionary<string, object> arguments);
        ...
        /// </remarks>
        [AmqpMethodDoNotImplement(null)]
        Task ExchangeUnbindNoWait(string destination, string source, string routingKey,
            IDictionary<string, object> arguments);
        ...
        ///   </para>
        /// </remarks>        
        Task QueueBindNoWait(string queue, string exchange, string routingKey, IDictionary<string, object> arguments);
        ...
        /// will be no response from the server).
        /// </summary>
        Task QueueDeclareNoWait(string queue, bool durable,
        ...
        [AmqpMethodDoNotImplement(null)]
        Task<uint> MessageCount(string queue);
        ...
        /// <param name="queue">The name of the queue</param>
        [AmqpMethodDoNotImplement(null)]
        Task<uint> ConsumerCount(string queue);
        ...
        /// </remarks>
        [AmqpMethodDoNotImplement(null)]
        Task<uint> QueueDelete(string queue, bool ifUnused, bool ifEmpty);

        /// <summary>
        ///Same as QueueDelete but sets nowait parameter to true
        ///and returns void (as there will be no response from the server)
        /// </summary>
        Task QueueDeleteNoWait(string queue, bool ifUnused, bool ifEmpty);
