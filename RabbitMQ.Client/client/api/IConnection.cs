...
namespace RabbitMQ.Client
{
    ...
    /// </para>
    /// </remarks>
    public interface IConnection : NetworkConnection
    {
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        Task Abort(ushort reasonCode, string reasonText);
        ...
        /// </para>
        /// </remarks>
        Task Abort(ushort reasonCode, string reasonText, int timeout);
        ...
        /// </para>
        /// </remarks>
        Task Close(ushort reasonCode, string reasonText);
        ...
        /// </para>
        /// </remarks>
        Task Close(ushort reasonCode, string reasonText, int timeout);
