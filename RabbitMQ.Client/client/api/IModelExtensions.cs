...
namespace RabbitMQ.Client
{
    public static class IModelExensions
    {
        ...
        public static Task<string> BasicConsume(this IModel model,
        ...
        /// <summary>Start a Basic content-class consumer.</summary>
        public static Task<string> BasicConsume(this IModel model, string queue, bool autoAck, IBasicConsumer consumer)
        {
            return model.BasicConsume(queue, autoAck, "", false, false, null, consumer);
        }

        /// <summary>Start a Basic content-class consumer.</summary>
        public static Task<string> BasicConsume(this IModel model, string queue,
            bool autoAck,
            string consumerTag,
            IBasicConsumer consumer)
        {
        ...
        /// </summary>
        public static Task<QueueDeclareOk> QueueDeclare(this IModel model, string queue = "", bool durable = false,
            bool exclusive = true,
        ...
        /// </summary>
        public static Task ExchangeBind(this IModel model, string destination, string source, string routingKey, IDictionary<string, object> arguments = null)
        {
        ...
        /// </summary>
        public static Task ExchangeBindNoWait(this IModel model, string destination, string source, string routingKey, IDictionary<string, object> arguments = null)
        {
        ...
        /// </summary>
        public static Task ExchangeDeclare(this IModel model, string exchange, string type, bool durable = false,
        ...
        /// </summary>
        public static Task ExchangeDeclareNoWait(this IModel model, string exchange, string type, bool durable = false,
            bool autoDelete = false,
            IDictionary<string, object> arguments = null)
        {
        ...
        /// </summary>
        public static Task ExchangeUnbind(this IModel model, string destination,
            string source,
            string routingKey,
            IDictionary<string, object> arguments = null)
        {
        ...
        /// </summary>
        public static Task ExchangeDelete(this IModel model, string exchange, bool ifUnused = false)
        {
        ...
        /// </summary>
        public static Task ExchangeDeleteNoWait(this IModel model, string exchange, bool ifUnused = false)
        {
        ...
        /// </summary>
        public static Task QueueBind(this IModel model, string queue, string exchange, string routingKey, IDictionary<string, object> arguments = null)
        {
        ...
        /// </summary>
        public static Task<uint> QueueDelete(this IModel model, string queue, bool ifUnused = false, bool ifEmpty = false)
        {
        ...
        /// </summary>
        public static Task QueueDeleteNoWait(this IModel model, string queue, bool ifUnused = false, bool ifEmpty = false)
        {
        ...
        /// </summary>
        public static Task QueueUnbind(this IModel model, string queue, string exchange, string routingKey, IDictionary<string, object> arguments = null)
        {
