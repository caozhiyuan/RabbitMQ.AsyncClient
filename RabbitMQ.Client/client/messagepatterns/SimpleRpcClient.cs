...
namespace RabbitMQ.Client.MessagePatterns
{
    ...
    public class SimpleRpcClient
    {
        ...
        public virtual async Task<object[]> Call(params object[] args)
        {
            IStreamMessageBuilder builder = new StreamMessageBuilder(Model);
            builder.WriteObjects(args);
            var reply = await Call0((IBasicProperties)builder.GetContentHeader(),
            ...
            var replyProperties = reply.BasicProperties;
        ...
        ///</para>
        ///</remarks>
        public virtual async Task<byte[]> Call(byte[] body)
        {
            BasicDeliverEventArgs reply = await Call(null, body);
        ...
        ///</para>
        ///</remarks>
        public virtual async Task<BasicDeliverEventArgs> Call0(IBasicProperties requestProperties,
            byte[] body)
        {
            BasicDeliverEventArgs reply = await Call(requestProperties, body);
            return reply;
        }
        ...
        public virtual async Task<BasicDeliverEventArgs> Call(IBasicProperties requestProperties, byte[] body)
        {
            ...
            await Cast(requestProperties, body);
            return await RetrieveReply(requestProperties.CorrelationId);
        }

        ///<summary>Sends an asynchronous/one-way message to the
        ///service.</summary>
        public virtual Task Cast(IBasicProperties requestProperties,
            byte[] body)
        {
            return Model.BasicPublish(Address,
                requestProperties,
                body);
        }
        ...
        protected virtual async Task EnsureSubscription()
        {
            if (Subscription == null)
            {
        ...
        ///</remarks>
        protected virtual async Task<BasicDeliverEventArgs> RetrieveReply(string correlationId)
        {
