...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    public class ConnectionStart : RabbitMQ.Client.Impl.MethodBase, IConnectionStart
    {
        ...
        byte IConnectionStart.VersionMajor
        {
            get { return m_versionMajor; }
        }

        byte IConnectionStart.VersionMinor
        {
            get { return m_versionMinor; }
        }

        System.Collections.Generic.IDictionary<string, object> IConnectionStart.ServerProperties
        {
            get { return m_serverProperties; }
        }

        byte[] IConnectionStart.Mechanisms
        {
            get { return m_mechanisms; }
        }

        byte[] IConnectionStart.Locales
        {
        ...
        public override int ProtocolMethodId
        {
            get { return 10; }
        }

        public override string ProtocolMethodName
        {
            get { return "connection.start"; }
        }
        ...
        {
            sb.Append("(");
            sb.Append(m_versionMajor);
            sb.Append(",");
            sb.Append(m_versionMinor);
            sb.Append(",");
            sb.Append(m_serverProperties);
            sb.Append(",");
            sb.Append(m_mechanisms);
            sb.Append(",");
            sb.Append(m_locales);
            sb.Append(")");
        }
    ...
    public class ConnectionStartOk : RabbitMQ.Client.Impl.MethodBase, IConnectionStartOk
    {
        ...
        System.Collections.Generic.IDictionary<string, object> IConnectionStartOk.ClientProperties
        {
            get { return m_clientProperties; }
        }

        string IConnectionStartOk.Mechanism
        {
            get { return m_mechanism; }
        }

        byte[] IConnectionStartOk.Response
        {
            get { return m_response; }
        }

        string IConnectionStartOk.Locale
        {
            get { return m_locale; }
        }
        ...
        public override string ProtocolMethodName
        {
            get { return "connection.start-ok"; }
        }
        ...
        {
            sb.Append("(");
            sb.Append(m_clientProperties);
            sb.Append(",");
            sb.Append(m_mechanism);
            sb.Append(",");
    ...
    public class ConnectionSecure : RabbitMQ.Client.Impl.MethodBase, IConnectionSecure
    {
        ...
        byte[] IConnectionSecure.Challenge
        {
    ...
    public class ConnectionSecureOk : RabbitMQ.Client.Impl.MethodBase, IConnectionSecureOk
    {
        ...
        byte[] IConnectionSecureOk.Response
        {
            get { return m_response; }
        }
        ...
        public override string ProtocolMethodName
        {
            get { return "connection.secure-ok"; }
        }
    ...
    public class ConnectionTune : RabbitMQ.Client.Impl.MethodBase, IConnectionTune
    {
        ...
        ushort IConnectionTune.ChannelMax
        {
            get { return m_channelMax; }
        }

        uint IConnectionTune.FrameMax
        {
            get { return m_frameMax; }
        }

        ushort IConnectionTune.Heartbeat
        {
        ...
        {
            sb.Append("(");
            sb.Append(m_channelMax);
            sb.Append(",");
            sb.Append(m_frameMax);
            sb.Append(",");
    ...
    public class ConnectionTuneOk : RabbitMQ.Client.Impl.MethodBase, IConnectionTuneOk
    {
        ...
        ushort IConnectionTuneOk.ChannelMax
        {
            get { return m_channelMax; }
        }

        uint IConnectionTuneOk.FrameMax
        {
            get { return m_frameMax; }
        }

        ushort IConnectionTuneOk.Heartbeat
        {
            get { return m_heartbeat; }
        }
    ...
    public class ConnectionOpen : RabbitMQ.Client.Impl.MethodBase, IConnectionOpen
    {
        ...
        string IConnectionOpen.VirtualHost
        {
            get { return m_virtualHost; }
        }

        string IConnectionOpen.Reserved1
        {
            get { return m_reserved1; }
        }

        bool IConnectionOpen.Reserved2
        {
    ...
    public class ConnectionOpenOk : RabbitMQ.Client.Impl.MethodBase, IConnectionOpenOk
    {
        ...
        string IConnectionOpenOk.Reserved1
        {
            get { return m_reserved1; }
        }
    ...
    public class ConnectionClose : RabbitMQ.Client.Impl.MethodBase, IConnectionClose
    {
        ...
        ushort IConnectionClose.ReplyCode
        {
            get { return m_replyCode; }
        }

        string IConnectionClose.ReplyText
        {
            get { return m_replyText; }
        }

        ushort IConnectionClose.ClassId
        {
            get { return m_classId; }
        }

        ushort IConnectionClose.MethodId
        {
    ...
    public class ConnectionCloseOk : RabbitMQ.Client.Impl.MethodBase, IConnectionCloseOk
    {
        ...
        public override string ProtocolMethodName
        {
            get { return "connection.close-ok"; }
        }
    ...
    public class ConnectionBlocked : RabbitMQ.Client.Impl.MethodBase, IConnectionBlocked
    {
        ...
        string IConnectionBlocked.Reason
        {
            get { return m_reason; }
        }
    ...
    public class ConnectionUnblocked : RabbitMQ.Client.Impl.MethodBase, IConnectionUnblocked
    {
        ...
        public override string ProtocolMethodName
        {
            get { return "connection.unblocked"; }
        }
    ...
    public class ChannelClose : RabbitMQ.Client.Impl.MethodBase, IChannelClose
    {
        ...
        ushort IChannelClose.ReplyCode
        {
            get { return m_replyCode; }
        }

        string IChannelClose.ReplyText
        {
            get { return m_replyText; }
        }

        ushort IChannelClose.ClassId
        {
            get { return m_classId; }
        }

        ushort IChannelClose.MethodId
        {
            get { return m_methodId; }
        }
    ...
    public class ExchangeDeclare : RabbitMQ.Client.Impl.MethodBase, IExchangeDeclare
    {
        ...
        ushort IExchangeDeclare.Reserved1
        {
            get { return m_reserved1; }
        }

        string IExchangeDeclare.Exchange
        {
            get { return m_exchange; }
        }

        string IExchangeDeclare.Type
        {
            get { return m_type; }
        }

        bool IExchangeDeclare.Passive
        {
            get { return m_passive; }
        }

        bool IExchangeDeclare.Durable
        {
            get { return m_durable; }
        }

        bool IExchangeDeclare.AutoDelete
        {
            get { return m_autoDelete; }
        }

        bool IExchangeDeclare.Internal
        {
            get { return m_internal; }
        }

        bool IExchangeDeclare.Nowait
        {
            get { return m_nowait; }
        }

        System.Collections.Generic.IDictionary<string, object> IExchangeDeclare.Arguments
        {
        ...
        public override void AppendArgumentDebugStringTo(System.Text.StringBuilder sb)
        {
            ...
            sb.Append(m_durable);
            sb.Append(",");
            sb.Append(m_autoDelete);
            sb.Append(",");
            sb.Append(m_internal);
            sb.Append(",");
            sb.Append(m_nowait);
            sb.Append(",");
    ...
    public class ExchangeDeclareOk : RabbitMQ.Client.Impl.MethodBase, IExchangeDeclareOk
    {
        ...
        public override string ProtocolMethodName
        {
            get { return "exchange.declare-ok"; }
        }
    ...
    public class ExchangeDelete : RabbitMQ.Client.Impl.MethodBase, IExchangeDelete
    {
        ...
        ushort IExchangeDelete.Reserved1
        {
            get { return m_reserved1; }
        }

        string IExchangeDelete.Exchange
        {
            get { return m_exchange; }
        }

        bool IExchangeDelete.IfUnused
        {
            get { return m_ifUnused; }
        }

        bool IExchangeDelete.Nowait
        {
            get { return m_nowait; }
        }
    ...
    public class ExchangeBind : RabbitMQ.Client.Impl.MethodBase, IExchangeBind
    {
        ...
        ushort IExchangeBind.Reserved1
        {
            get { return m_reserved1; }
        }

        string IExchangeBind.Destination
        {
            get { return m_destination; }
        }

        string IExchangeBind.Source
        {
            get { return m_source; }
        }

        string IExchangeBind.RoutingKey
        {
            get { return m_routingKey; }
        }

        bool IExchangeBind.Nowait
        {
            get { return m_nowait; }
        }

        System.Collections.Generic.IDictionary<string, object> IExchangeBind.Arguments
        {
            get { return m_arguments; }
        }
    ...
    public class ExchangeUnbind : RabbitMQ.Client.Impl.MethodBase, IExchangeUnbind
    {
        ...
        ushort IExchangeUnbind.Reserved1
        {
            get { return m_reserved1; }
        }

        string IExchangeUnbind.Destination
        {
            get { return m_destination; }
        }

        string IExchangeUnbind.Source
        {
            get { return m_source; }
        }

        string IExchangeUnbind.RoutingKey
        {
            get { return m_routingKey; }
        }

        bool IExchangeUnbind.Nowait
        {
            get { return m_nowait; }
        }

        System.Collections.Generic.IDictionary<string, object> IExchangeUnbind.Arguments
        {
            get { return m_arguments; }
        }
    ...
    public class QueueDeclare : RabbitMQ.Client.Impl.MethodBase, IQueueDeclare
    {
        ...
        ushort IQueueDeclare.Reserved1
        {
            get { return m_reserved1; }
        }

        string IQueueDeclare.Queue
        {
            get { return m_queue; }
        }

        bool IQueueDeclare.Passive
        {
            get { return m_passive; }
        }
        ...
        bool IQueueDeclare.Exclusive
        {
            get { return m_exclusive; }
        }

        bool IQueueDeclare.AutoDelete
        {
            get { return m_autoDelete; }
        }

        bool IQueueDeclare.Nowait
        {
            get { return m_nowait; }
        }

        System.Collections.Generic.IDictionary<string, object> IQueueDeclare.Arguments
        {
            get { return m_arguments; }
        }
    ...
    public class QueueDeclareOk : RabbitMQ.Client.Impl.MethodBase, IQueueDeclareOk
    {
        ...
        string IQueueDeclareOk.Queue
        {
            get { return m_queue; }
        }

        uint IQueueDeclareOk.MessageCount
        {
            get { return m_messageCount; }
        }

        uint IQueueDeclareOk.ConsumerCount
        {
    ...
    public class QueueBind : RabbitMQ.Client.Impl.MethodBase, IQueueBind
    {
        ...
        ushort IQueueBind.Reserved1
        {
            get { return m_reserved1; }
        }

        string IQueueBind.Queue
        {
            get { return m_queue; }
        }

        string IQueueBind.Exchange
        {
            get { return m_exchange; }
        }

        string IQueueBind.RoutingKey
        {
            get { return m_routingKey; }
        }

        bool IQueueBind.Nowait
        {
            get { return m_nowait; }
        }

        System.Collections.Generic.IDictionary<string, object> IQueueBind.Arguments
        {
            get { return m_arguments; }
        }
    ...
    public class QueueUnbind : RabbitMQ.Client.Impl.MethodBase, IQueueUnbind
    {
        ...
        ushort IQueueUnbind.Reserved1
        {
            get { return m_reserved1; }
        }

        string IQueueUnbind.Queue
        {
            get { return m_queue; }
        }

        string IQueueUnbind.Exchange
        {
            get { return m_exchange; }
        }

        string IQueueUnbind.RoutingKey
        {
            get { return m_routingKey; }
        }

        System.Collections.Generic.IDictionary<string, object> IQueueUnbind.Arguments
        {
            get { return m_arguments; }
        }
    ...
    public class QueuePurge : RabbitMQ.Client.Impl.MethodBase, IQueuePurge
    {
        ...
        ushort IQueuePurge.Reserved1
        {
            get { return m_reserved1; }
        }

        string IQueuePurge.Queue
        {
            get { return m_queue; }
        }

        bool IQueuePurge.Nowait
        {
            get { return m_nowait; }
        }
    ...
    public class QueuePurgeOk : RabbitMQ.Client.Impl.MethodBase, IQueuePurgeOk
    {
        ...
        uint IQueuePurgeOk.MessageCount
        {
            get { return m_messageCount; }
        }
    ...
    public class QueueDelete : RabbitMQ.Client.Impl.MethodBase, IQueueDelete
    {
        ...
        ushort IQueueDelete.Reserved1
        {
            get { return m_reserved1; }
        }

        string IQueueDelete.Queue
        {
            get { return m_queue; }
        }

        bool IQueueDelete.IfUnused
        {
            get { return m_ifUnused; }
        }

        bool IQueueDelete.IfEmpty
        {
            get { return m_ifEmpty; }
        }

        bool IQueueDelete.Nowait
        {
            get { return m_nowait; }
        }
    ...
    public class QueueDeleteOk : RabbitMQ.Client.Impl.MethodBase, IQueueDeleteOk
    {
        ...
        uint IQueueDeleteOk.MessageCount
        {
            get { return m_messageCount; }
        }
    ...
    public class BasicQos : RabbitMQ.Client.Impl.MethodBase, IBasicQos
    {
        ...
        uint IBasicQos.PrefetchSize
        {
            get { return m_prefetchSize; }
        }

        ushort IBasicQos.PrefetchCount
        {
            get { return m_prefetchCount; }
        }

        bool IBasicQos.Global
        {
            get { return m_global; }
        }
        ...
        {
            sb.Append("(");
            sb.Append(m_prefetchSize);
            sb.Append(",");
            sb.Append(m_prefetchCount);
            sb.Append(",");
            sb.Append(m_global);
            sb.Append(")");
        }
    ...
    public class BasicConsume : RabbitMQ.Client.Impl.MethodBase, IBasicConsume
    {
        ...
        ushort IBasicConsume.Reserved1
        {
            get { return m_reserved1; }
        }

        string IBasicConsume.Queue
        {
            get { return m_queue; }
        }

        string IBasicConsume.ConsumerTag
        {
            get { return m_consumerTag; }
        }

        bool IBasicConsume.NoLocal
        {
            get { return m_noLocal; }
        }

        bool IBasicConsume.NoAck
        {
            get { return m_noAck; }
        }

        bool IBasicConsume.Exclusive
        {
            get { return m_exclusive; }
        }

        bool IBasicConsume.Nowait
        {
            get { return m_nowait; }
        }

        System.Collections.Generic.IDictionary<string, object> IBasicConsume.Arguments
        {
            get { return m_arguments; }
        }
    ...
    public class BasicConsumeOk : RabbitMQ.Client.Impl.MethodBase, IBasicConsumeOk
    {
        ...
        string IBasicConsumeOk.ConsumerTag
        {
            get { return m_consumerTag; }
        }
    ...
    public class BasicCancel : RabbitMQ.Client.Impl.MethodBase, IBasicCancel
    {
        ...
        string IBasicCancel.ConsumerTag
        {
            get { return m_consumerTag; }
        }

        bool IBasicCancel.Nowait
        {
            get { return m_nowait; }
        }
    ...
    public class BasicCancelOk : RabbitMQ.Client.Impl.MethodBase, IBasicCancelOk
    {
        ...
        string IBasicCancelOk.ConsumerTag
        {
            get { return m_consumerTag; }
        }
    ...
    public class BasicPublish : RabbitMQ.Client.Impl.MethodBase, IBasicPublish
    {
        ...
        ushort IBasicPublish.Reserved1
        {
            get { return m_reserved1; }
        }

        string IBasicPublish.Exchange
        {
            get { return m_exchange; }
        }

        string IBasicPublish.RoutingKey
        {
            get { return m_routingKey; }
        }

        bool IBasicPublish.Mandatory
        {
            get { return m_mandatory; }
        }

        bool IBasicPublish.Immediate
        {
    ...
    public class BasicReturn : RabbitMQ.Client.Impl.MethodBase, IBasicReturn
    {
        ...
        ushort IBasicReturn.ReplyCode
        {
            get { return m_replyCode; }
        }

        string IBasicReturn.ReplyText
        {
            get { return m_replyText; }
        }

        string IBasicReturn.Exchange
        {
            get { return m_exchange; }
        }

        string IBasicReturn.RoutingKey
        {
            get { return m_routingKey; }
        }
    ...
    public class BasicDeliver : RabbitMQ.Client.Impl.MethodBase, IBasicDeliver
    {
        ...
        string IBasicDeliver.ConsumerTag
        {
            get { return m_consumerTag; }
        }

        ulong IBasicDeliver.DeliveryTag
        {
            get { return m_deliveryTag; }
        }

        bool IBasicDeliver.Redelivered
        {
            get { return m_redelivered; }
        }

        string IBasicDeliver.Exchange
        {
            get { return m_exchange; }
        }

        string IBasicDeliver.RoutingKey
        {
            get { return m_routingKey; }
        }
        ...
        public override void AppendArgumentDebugStringTo(System.Text.StringBuilder sb)
        {
            ...
            sb.Append(m_consumerTag);
            sb.Append(",");
            sb.Append(m_deliveryTag);
            sb.Append(",");
            sb.Append(m_redelivered);
            sb.Append(",");
            sb.Append(m_exchange);
            sb.Append(",");
            sb.Append(m_routingKey);
    ...
    public class BasicGet : RabbitMQ.Client.Impl.MethodBase, IBasicGet
    {
        ...
        ushort IBasicGet.Reserved1
        {
            get { return m_reserved1; }
        }

        string IBasicGet.Queue
        {
            get { return m_queue; }
        }

        bool IBasicGet.NoAck
        {
            get { return m_noAck; }
        }
    ...
    public class BasicGetOk : RabbitMQ.Client.Impl.MethodBase, IBasicGetOk
    {
        ...
        ulong IBasicGetOk.DeliveryTag
        {
            get { return m_deliveryTag; }
        }

        bool IBasicGetOk.Redelivered
        {
            get { return m_redelivered; }
        }

        string IBasicGetOk.Exchange
        {
            get { return m_exchange; }
        }

        string IBasicGetOk.RoutingKey
        {
            get { return m_routingKey; }
        }

        uint IBasicGetOk.MessageCount
        {
            get { return m_messageCount; }
        }
    ...
    public class BasicGetEmpty : RabbitMQ.Client.Impl.MethodBase, IBasicGetEmpty
    {
        ...
        string IBasicGetEmpty.Reserved1
        {
            get { return m_reserved1; }
        }
    ...
    public class BasicAck : RabbitMQ.Client.Impl.MethodBase, IBasicAck
    {
        ...
        ulong IBasicAck.DeliveryTag
        {
            get { return m_deliveryTag; }
        }

        bool IBasicAck.Multiple
        {
    ...
    public class BasicReject : RabbitMQ.Client.Impl.MethodBase, IBasicReject
    {
        ...
        ulong IBasicReject.DeliveryTag
        {
            get { return m_deliveryTag; }
        }

        bool IBasicReject.Requeue
        {
    ...
    public class BasicRecoverAsync : RabbitMQ.Client.Impl.MethodBase, IBasicRecoverAsync
    {
        ...
        bool IBasicRecoverAsync.Requeue
        {
            get { return m_requeue; }
        }
        ...
        public override string ProtocolMethodName
        {
            get { return "basic.recover-async"; }
        }
    ...
    public class BasicNack : RabbitMQ.Client.Impl.MethodBase, IBasicNack
    {
        ...
        ulong IBasicNack.DeliveryTag
        {
            get { return m_deliveryTag; }
        }

        bool IBasicNack.Multiple
        {
            get { return m_multiple; }
        }

        bool IBasicNack.Requeue
        {
            get { return m_requeue; }
        }
    ...
    public class Model : RabbitMQ.Client.Impl.ModelBase
    {
        ...
        public Model(RabbitMQ.Client.Impl.ISession session, RabbitMQ.Client.ConsumerWorkService workService) : base(
            session, workService)
        {
        }

        public override Task ConnectionTuneOk(
            ushort @channelMax,
            uint @frameMax,
            ushort @heartbeat)
        {
            ...
            return ModelSend(__req, null, null);
        }

        public override Task _Private_BasicCancel(
            string @consumerTag,
            bool @nowait)
        {
        ...
        public override Task _Private_BasicConsume(
            string @queue,
            string @consumerTag,
            bool @noLocal,
            bool @autoAck,
        ...
        public override Task _Private_BasicGet(
            string @queue,
            bool @autoAck)
        {
        ...
        public override Task _Private_BasicPublish(
            string @exchange,
            string @routingKey,
            bool @mandatory,
            ...
            byte[] @body)
        {
            ...
            return ModelSend(__req, (BasicProperties) basicProperties, body);
        }

        public override Task _Private_BasicRecover(
            bool @requeue)
        {
        ...
        public override Task _Private_ChannelClose(
            ushort @replyCode,
            string @replyText,
            ushort @classId,
            ushort @methodId)
        ...
        public override Task _Private_ChannelCloseOk()
        {
            ChannelCloseOk __req = new ChannelCloseOk();
            return ModelSend(__req, null, null);
        }

        public override Task _Private_ChannelFlowOk(
            bool @active)
        {
        ...
        public override async Task _Private_ChannelOpen(
            string @outOfBand)
        {
            ChannelOpen __req = new ChannelOpen();
            __req.m_reserved1 = @outOfBand;
            RabbitMQ.Client.Impl.MethodBase __repBase = await ModelRpc(__req, null, null);
            ChannelOpenOk __rep = __repBase as ChannelOpenOk;
            if (__rep == null) throw new UnexpectedMethodException(__repBase);
        }

        public override async Task _Private_ConfirmSelect(
            bool @nowait)
        {
            ...
            if (nowait)
            {
                await ModelSend(__req, null, null);
                return;
            }
        ...
        public override async Task _Private_ConnectionClose(
            ushort @replyCode,
            string @replyText,
            ushort @classId,
            ushort @methodId)
        ...
        public override Task _Private_ConnectionCloseOk()
        {
            ConnectionCloseOk __req = new ConnectionCloseOk();
            return ModelSend(__req, null, null);
        }

        public override Task _Private_ConnectionOpen(
            string @virtualHost,
            string @capabilities,
            bool @insist)
        {
        ...
        public override Task _Private_ConnectionSecureOk(
            byte[] @response)
        {
        ...
        public override Task _Private_ConnectionStartOk(
        ...
        public override async Task _Private_ExchangeBind(
            string @destination,
            string @source,
            string @routingKey,
            bool @nowait,
        ...
        public override async Task _Private_ExchangeDeclare(
            string @exchange,
            string @type,
            bool @passive,
            bool @durable,
        ...
        public override async Task _Private_ExchangeDelete(
            string @exchange,
            bool @ifUnused,
            bool @nowait)
        {
        ...
        public override async Task _Private_ExchangeUnbind(
            string @destination,
            string @source,
            string @routingKey,
            bool @nowait,
        ...
        public override async Task _Private_QueueBind(
            string @queue,
            string @exchange,
            string @routingKey,
            bool @nowait,
        ...
        public override Task _Private_QueueDeclare(
            string @queue,
            bool @passive,
            bool @durable,
            bool @exclusive,
        ...
        public override async Task<uint> _Private_QueueDelete(
            string @queue,
            bool @ifUnused,
            bool @ifEmpty,
            bool @nowait)
        ...
        public override async Task<uint> _Private_QueuePurge(
            string @queue,
            bool @nowait)
        {
        ...
        public override Task BasicNack(
            ulong @deliveryTag,
            bool @multiple,
            bool @requeue)
        {
        ...
        public override async Task BasicQos(
            uint @prefetchSize,
        ...
        public override Task BasicRecoverAsync(
            bool @requeue)
        {
        ...
        public override Task BasicReject(
            ulong @deliveryTag,
            bool @requeue)
        {
        ...
        public override async Task QueueUnbind(
            string @queue,
            string @exchange,
            string @routingKey,
            System.Collections.Generic.IDictionary<string, object> @arguments)
        ...
        public override async Task TxCommit()
        {
        ...
        public override async Task TxRollback()
        {
        ...
        public override async Task TxSelect()
        {
